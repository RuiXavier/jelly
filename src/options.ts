...
export const options: {
    ...
    callstacksJson: string | undefined,
 ...
 * Without this, commander returns the raw string and use sites rely on
 * JavaScript coercion, which silently misbehaves on bad input.
 */
